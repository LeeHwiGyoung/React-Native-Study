...
export interface FollowSuggestUserSimple extends User {
  isVerified?: boolean;
}

const FollowSuggestSimple = ({ item }: { item: FollowSuggestUserSimple }) => {
  ...
  return (
    ...
    >
      ...
      <View style={styles.userInfoContainer}>
        ...
        {/* User Follower Count */}
        <View style={styles.userInfoFooter}></View>
      </View>
...
export default FollowSuggestSimple;
